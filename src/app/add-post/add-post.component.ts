...
export class AddPostComponent implements OnInit{
  ...
  constructor(private sanitizer: DomSanitizer,private postsService: PostsService, private formBuilder: FormBuilder, private router: Router)
  {
  ...
  ngOnInit(): void {
    ...
    this.renderedMarkdown = this.sanitizer.bypassSecurityTrustHtml(marked(this.markdownContent));
  }
